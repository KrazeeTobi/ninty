...
function defaultMov(){	
	//setMov('../report/flv/' + defaultMovFile,2,2,'img/' + defaultMovFile + '.jpg');
	setMov('report/' + defaultMovFile,1,2,'img/' + defaultMovFile + '.jpg');
}
...
function changeVideo(flvName) {	
	...
	setMov('report/' + defaultMovFile,1,1,'img/' + defaultMovFile + '.jpg');
