...
function defaultMov(){	
	setMov('../interview/flv/' + defaultMovFile,2,2,'img/' + defaultMovFile + '.jpg');
}
...
$(document).ready(function(){
	...
	if(!location.hash.split('#')[1]) {
		...
		$(".contentsWrap .wrap .main .con02 #interviewBTN").removeClass("current");
		$(".contentsWrap .wrap .main .con02 .con02list li").removeClass("current");
		$(".contentsWrap .wrap .main .con02 #interviewBTN .cu").css("display" , "none");
		$(".contentsWrap .wrap .main .con02 .con02list li .cu").css("display" , "none");
		$(".contentsWrap .wrap .main .con02 #interviewBTN a").css("display" , "block");
...
function changeVideo(flvName) {	
	...
	setMov('../interview/flv/' + defaultMovFile,2,1,'img/' + defaultMovFile + '.jpg');
